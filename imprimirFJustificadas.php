...
$pdf->SetTitle('Relatório de Faltas Justificadas');
...
<head>
<meta charset='UTF-8'>
<title>Relatório de Faltas Justificadas</title>
...
<body>
<h2>Relatório de Faltas Justificadas</h2>
...
$sql="SELECT * FROM justificarfalta";
...
$pdf->Output('relatorio_faltas_justificadas.pdf', 'I');
