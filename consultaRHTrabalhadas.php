...
$sql = "SELECT * FROM horastrabalhadas where nome like '%$filtro%' order by id_HTrabalhadas";
...
<script>
        function imprimirPDF() {
            ...
            window.location.href = 'imprimirHTrabalhadas.php';
        }
    </script>
...
<div>
          <h3>Relatórios Horas Trabalhadas</h3>
          <hr></br></br>
...
while ($exibirRegistros = mysqli_fetch_array($consulta)) {
    ...
    // Linha da tabela
    echo "<tr>
            <td id='idPferias'><b>$id_HTrabalhadas</b></td>
            <td>$nome</td>
            <td>$data</td>
            <td>$horainicio</td>
            <td>$horatermino</td>
