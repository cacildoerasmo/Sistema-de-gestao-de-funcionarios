...
<?php
    ...
    $sql = "INSERT INTO pedidodispensa (nome,email,dataHoje,estado,departamento,telefone,documento,comentario,codigo) values ('$nome','$email','$dataHoje','$estado','$departamento','$telefone','$documento','$comentario','$codigo')";
