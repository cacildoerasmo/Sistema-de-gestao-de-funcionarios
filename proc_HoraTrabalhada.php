...
<?php
    ...
    $sql = "INSERT INTO horastrabalhadas (nome,datahoje,horainicio,horatermino,horatrabalhada,tipoaula,departamento,telefone,documento,comentario,codigo) values ('$nome','$dataHoje','$horainicio','$horatermino','$horatrabalhada','$tipoaula','$departamento','$telefone','$documento','$comentario','$codigo')";
