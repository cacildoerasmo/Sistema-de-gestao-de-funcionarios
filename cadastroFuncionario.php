...
<form method="post" action="procFuncionario.php">
    

    <h3>Cadastro de Funcion&aacute;rios</h3>
    <hr>
    <div class="form-row">
     <div class="col-6"> 
 ...
 <input class="form-check-input" type="radio" name="sexo" id="inlineRadio1" value="M" checked>
 ...
 <div class="col-5"> 
    <label for="inputDate">Data de Nascimento</label>
     <input type="date" name="data_de_nascimento"class="form-control form-control-sm" id="inputDate"> 
    </div>
    ...
    <div class="col"> 
        ...
        <div class="form-group"> 
           <label for="estadosivil">Estado Civil</label>
             <input type="text" name="estadocivil" class="form-control form-control-sm" id="estadosivil" placeholder="Solteiro, Casado..." maxlength="40" required> 
            </div>  
            ...
            <div class="col-6"> 
                <label for="nacionalidade">Nacionalidade</label>
                 <input type="text" name="nacionalidade" class="form-control form-control-sm" id="nacionalidade" placeholder="A sua nacionalidade" maxlength="40" required> 
                </div>    

                <div class="form-group"> 
                    <label for="cidade">Cidade</label>
                     <input type="text" name="cidade" class="form-control form-control-sm" id="cidade" placeholder="A sua cidade atual" maxlength="40" required> 
                    </div>       
            ...
            <label for="profissao">Departamento</label>
             <input type="text" name="departamento" class="form-control form-control-sm" id="departamento" maxlength="40" required> 
                    ...
                    <div class="col-5">
                        ...
                        <input type="text" name="nome_do_pai" class="form-control form-control-sm" id="nomepai" placeholder="Nome Completo" maxlength="40" required>
                        </div>

                          <div class="col">
                               <label for="nomemae">Nome da m&atilde;e</label>
                             <input type="text" name="nome_da_mae" class="form-control form-control-sm" id="nomemae" placeholder="Nome  Completo" maxlength="40" required> 
                            </div>
