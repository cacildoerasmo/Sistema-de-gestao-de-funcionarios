...
$sql = "SELECT * FROM pedidodispensa where nome like '%$filtro%' order by id_Pdispensa";
...
<script>
        function imprimirPDF() {
            ...
            window.location.href = 'imprimirRRDispensa.php';
        }
    </script>
...
<div>
          <h3>Relatórios de Pedidos de Dispensa</h3>
          <hr></br></br>
